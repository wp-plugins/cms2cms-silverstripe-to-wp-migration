...
If you wish to migrate your current SilverStripe to WordPress - CMS2CMS Migration Plugin can help to convert all data totally automatedly in a few easy-to-do steps.
...
1. Go to Admin -> Plugins, find “SilverStripe to WordPress Migration” and click Activate.
